	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2>Hasta Girişi</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
							Giriş yapmak için lütfen adınızı ve şifrenizi girin.<br />
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase"><h5> Rami KOCO</h5> <h5>170255063</h5></span>
					</div>
