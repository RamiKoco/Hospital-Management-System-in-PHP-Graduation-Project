	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> Hasta Kaydı</h2></a>
				</div>
				...
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<p>
							Hesap ayrıntılarınızı aşağıya girin:
							</p>
							<div class="form-group">
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control"  id="password_again" name="password_again" placeholder="Şifre Tekrarı" required>
									<i class="fa fa-lock"></i> </span>
							</div>
							<div class="form-group">
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-right" id="submit" name="submit">
									Onayla <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</fieldset>
					</form>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> HYS</span><span></span>
					</div>
