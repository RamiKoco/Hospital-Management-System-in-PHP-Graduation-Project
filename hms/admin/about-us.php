...
$pagedes=$con->real_escape_string($_POST['pagedes']);
    ...
    echo '<script>alert("Hakkımızda Güncellenmiştir.")</script>';
  }
  else
    {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Hakkımızda İçeriğini Güncelleyin</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<li class="active">
										<span>Hakkımızda İçeriğini Güncelleyin</span>
									</li>
								</ol>
							</div>
						</section>
...
?>
                    ...
                    <?php } ?>
                    <button type="submit" class="btn btn-primary mr-2" name="submit">Onayla</button>
                  </form>
								</div>
							</div>
								</div>
