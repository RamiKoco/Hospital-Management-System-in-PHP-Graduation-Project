				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Bölüm | Bilgisayar Mühendisliği (İÖ)</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Kullanıcı </span>
...
{
	echo "Sizin Tarafınızdan İptal Edildi";
}
...
{ ?>
	...
	<a href="appointment-history.php?id=<?php echo $row['id']?>&cancel=update" onClick="return confirm('Bu randevuyu iptal etmek istediğinizden emin misiniz ?')"class="btn btn-transparent btn-xs tooltips" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove">İptal</a>
	<?php } else {
