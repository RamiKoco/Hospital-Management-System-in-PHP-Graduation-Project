...
if($sql)
{
$msg="Profiliniz Başarılı Bir Şekilde Güncellendi";
...
<html lang="tr">
	<head>
		<title>Kullanıcı | Profili Düzenleme</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-10">
									<h1 class="mainTitle">Fakülte | Mühendislik ve Mimarlık Fakültesi</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Kullanıcı </span>
...
<div class="form-group">
					...
					<a href="change-emaild.php">E-posta ID'inizi güncelleyin</a>
														</div>
